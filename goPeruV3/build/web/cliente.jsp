    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navegacion-goPeru">
                        <ul class="nav navbar-nav">
                            <li class="" ><a href="perfilcliente.jsp">Perfil</a></li>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">Nuestros Ofertas<span class="caret"></span>
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="">Listar ofertas</a></li>
                                        <li class="divider"></li>
                                        <li><a href="">Insertar ofertas</a></li>
                                        <li class="divider"></li>
                                        <li><a href="">Actualizar ofertas</a></li>
                                    </ul>
                                </a>
                            </li>
        ...
        <section class="jumbotron" style="margin-top:0px">
            <div class="container">
                ...
                <p class=" col-md-10 arribaizquierda titulo-web">"Bienvenido Cliente!"</p>   
            </div>
        </section>
            ...
            <div class="row">
                <div class="col-xs-6 col-md-6">
                    <div class="thumbnail" style="background-color:#F9D2D2">
                        ...
                        <div class="caption">
                            <p class="text-primary text-center lead" style="margin: 0"><strong>Ofertas</strong></p>
                ...
                <div class="col-xs-6 col-md-6">
                    <div class="thumbnail" style="background-color:#F9D2D2">
                        ...
                        <div class="caption">
                            <p class="text-primary text-center lead" style="margin: 0"><strong>Lugares</strong></p>
                            <p class="text-center"><a href="">Listar Lugares</a></p>
                            <p class="text-center"><a href="" class="text-center">Insertar Lugar</a></p>
                            <p class="text-center"><a href="">Actualizar Lugar</a></p>
                            <p class="text-center"><a href="">Eliminar Lugar</a></p>
                        </div>
                    </div>
                </div> 
            </div>        
